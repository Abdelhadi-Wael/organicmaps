               ...
               MenuBottomSheetFragment.MenuBottomSheetInterface
{
  ...
  private void showColorDialog(ImageView v, int position)
  {
    ...
    else if (type == BookmarkListAdapter.TYPE_BOOKMARK)
    {
      ...
      args.putInt(BookmarkColorDialogFragment.ICON_COLOR, PredefinedColors.getPredefinedColorIndex(bookmark.getIcon().getColor()));
      ...
      dialogFragment.setOnColorSetListener((colorPos) -> {
        ...
        Drawable icon = Graphics.drawCircleAndImage(to, R.dimen.track_circle_size, bookmark.getIcon().getResId(), R.dimen.bookmark_icon_size, requireContext());
